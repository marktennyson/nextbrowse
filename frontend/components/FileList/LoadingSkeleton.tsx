              ...
              >
                <div className="flex-1 sm:col-span-6 flex items-center space-x-3 sm:space-x-4">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    ></div>
                    <div
                      className="h-3 bg-slate-800 rounded animate-pulse sm:hidden"
      ...
      {Array.from({ length: 12 }).map((_, i) => (
        <div key={i} className="glass rounded-xl p-3 sm:p-4 md:p-6 text-center">
          <div className="flex justify-center mb-2 sm:mb-3 md:mb-4">
            <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-slate-700 rounded-lg animate-pulse"></div>
          </div>
          <div className="space-y-1 sm:space-y-2">
            <div
              className="h-3 sm:h-4 bg-slate-700 rounded animate-pulse mx-auto"
              style={{ width: `${50 + Math.random() * 40}%` }}
            ></div>
            <div
              className="h-3 bg-slate-800 rounded animate-pulse mx-auto hidden sm:block"
