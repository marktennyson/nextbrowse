    ...
    >
      <div
        className="w-full max-w-3xl h-[72vh] flex flex-col rounded-2xl
                   border border-zinc-800/60 bg-zinc-900/90 shadow-2xl"
        onMouseDown={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center gap-3 px-5 py-4 border-b border-zinc-800/60">
          <div className="flex items-center gap-2">
            <div className="h-9 w-9 rounded-xl grid place-items-center bg-gradient-to-br from-blue-400/10 to-indigo-400/10 ring-1 ring-inset ring-blue-500/20">
        ...
        <div className="px-5 py-3 border-b border-zinc-800/60">
          <div className="flex items-center gap-2 flex-wrap">
              ...
              {crumbs.map((seg, i) => {
                ...
                return (
                  <div key={to} className="flex items-center gap-1">
                      ...
                      className={`truncate max-w-[160px] rounded-lg px-2 py-1.5 text-xs font-medium transition-colors
                        ${
                          last
                            ...
                            : "bg-zinc-800/70 hover:bg-zinc-700 text-zinc-200"
                        }`}
                      title={to}
                    >
                      {seg}
                    ...
                    {!last && (
                      <ChevronRightIcon className="h-4 w-4 mx-0.5 text-zinc-500" />
                    )}
                  </div>
                );
              })}
            ...
            <div className="ml-auto relative">
              <MagnifyingGlassIcon className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-zinc-500" />
              <input
                ref={searchRef}
                type="text"
                ...
                className="w-[240px] rounded-xl bg-zinc-800/70
                ...
                {selectedPath !== "/" && (
                  <button
                    ...
                    className="mx-auto inline-flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium
                               bg-zinc-800/70 hover:bg-zinc-700 transition-colors"
                  >
              ...
              {filtered.map((dir, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <ChevronRightIcon className="ml-auto h-5 w-5 text-zinc-600" />
                  </button>
                );
              })}
            </div>
        ...
        {/* Footer */}
        <div className="px-5 py-4 border-t border-zinc-800/60 bg-zinc-900/60 backdrop-blur">
                ...
                className={`inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition-colors
                  ${
                    selectedPath === currentPath
                      ? "cursor-not-allowed border border-zinc-800/60 bg-zinc-800 text-zinc-500"
...
function LoadingList(): React.JSX.Element {
  return (
    <div className="h-full overflow-hidden">
      <div className="animate-pulse divide-y divide-zinc-800/60">
